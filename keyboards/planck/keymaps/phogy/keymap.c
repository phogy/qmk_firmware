...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FUNCTION] = LAYOUT_planck_grid(
    LCTL(KC_Q), LCTL(KC_W), LCTL(KC_E),LCTL(KC_R), KC_AUDIO_MUTE, KC_MEDIA_PLAY_PAUSE,
    KC_TRANSPARENT,KC_NUMLOCK,KC_KP_7,KC_KP_8,KC_KP_9,KC_KP_ASTERISK,
    LCTL(KC_A), LCTL(KC_S), LCTL(KC_D), LCTL(KC_F), KC_AUDIO_VOL_UP, KC_MEDIA_NEXT_TRACK,
    KC_TRANSPARENT,KC_KP_SLASH,KC_KP_4,KC_KP_5,KC_KP_6,KC_KP_MINUS,
    LCTL(KC_Z), LCTL(KC_X), LCTL(KC_C), LCTL(KC_V), KC_AUDIO_VOL_DOWN, KC_MEDIA_PREV_TRACK,
